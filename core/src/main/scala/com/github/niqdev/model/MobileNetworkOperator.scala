...
/**
  ...
  */
@silent
sealed abstract class MobileNetworkOperator(countryCallingCode: Int Refined Positive, website: String Refined Url) extends EnumEntry with Snakecase with Uppercase
...
object MobileNetworkOperator extends Enum[MobileNetworkOperator] {
  ...
  case object ThreeIe extends MobileNetworkOperator(countryCallingCode = 353, website = "https://www.three.ie")
